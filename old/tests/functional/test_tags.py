...
class TestTagsView(TestView):
    ...
    def test_index(self):
        ...
        response = self.app.get(
            url('index'), paginator, headers=self.json_headers,
            extra_environ=self.extra_environ_view)
        resp = response.json_body
        ...
        response = self.app.get(
            url('index'), order_by_params, headers=self.json_headers,
            extra_environ=self.extra_environ_view)
        resp = response.json_body
        ...
        response = self.app.get(
            url('index'), params, headers=self.json_headers,
            extra_environ=self.extra_environ_view)
        resp = response.json_body
        ...
        response = self.app.get(
            url('index'), order_by_params, status=400,
    ...
    def test_update(self):
        ...
        response = self.app.put(
            url('update', id=tag_id), params, self.json_headers,
            self.extra_environ_admin)
        resp = response.json_body
    ...
    def test_delete(self):
        ...
        response = self.app.delete(
            url('delete', id=tag_id), headers=self.json_headers,
    ...
    def test_show(self):
        ...
        id_ = 100000000000
        response = self.app.get(
            url('show', id=id_), headers=self.json_headers,
            extra_environ=self.extra_environ_admin, status=404)
        resp = response.json_body
    ...
    def test_edit(self):
        ...
        response = self.app.get(url('edit', id=tag_id), status=401)
        resp = response.json_body
        assert resp['error'] == (

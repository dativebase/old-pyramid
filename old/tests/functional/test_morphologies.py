...
class TestMorphologiesView(TestView):
    ...
    def test_b_compile(self):
        ...
        if not h.foma_installed():
            response = self.app.put(
                '/morphologies/{id}/generate_and_compile'.format(id=morphology_1_id),
        ...
        response = self.app.get(
            '/morphologies/{id}/servecompiled'.format(id=morphology_1_id),
            headers=self.json_headers,
        ...
        response = self.app.get(
            '/morphologies/{id}/servecompiled'.format(id=123456789),
            headers=self.json_headers,
        ...
        response = self.app.put(
            '/morphologies/{id}/applydown'.format(id=morphology_1_id),
        ...
        params = json.dumps({'morpheme_sequences': morpheme_sequence})
        response = self.app.put(
            '/morphologies/{id}/applyup'.format(id=morphology_1_id),
            params, self.json_headers, self.extra_environ_admin)
        resp = response.json_body
        morphology_dir_path = os.path.join(self.morphologies_path,
                                        'morphology_%d' % morphology_1_id)
        ...
        response = self.app.put(
            '/morphologies/{id}/generate_and_compile'.format(id=morphology_2_id),
            headers=self.json_headers,
            extra_environ=self.extra_environ_contrib)
        resp = response.json_body
        compile_attempt = resp['compile_attempt']
        ...
        response = self.app.put(
            '/morphologies/{id}/generate_and_compile'.format(id=morphology_3_id),
            headers=self.json_headers,
            extra_environ=self.extra_environ_contrib)
        resp = response.json_body
        compile_attempt = resp['compile_attempt']
        ...
        response = self.app.put(
            '/morphologies/{id}/generate_and_compile'.format(id=morphology_4_id),
            headers=self.json_headers,
            extra_environ=self.extra_environ_contrib)
        resp = response.json_body
        compile_attempt = resp['compile_attempt']
        ...
        response = self.app.put(
            '/morphologies/{id}/generate_and_compile'.format(id=morphology_5_id),
            headers=self.json_headers,
            extra_environ=self.extra_environ_contrib)
        resp = response.json_body
        compile_attempt = resp['compile_attempt']
        ...
        params = json.dumps({'morpheme_sequences': [ms1, ms2]})
        response = self.app.put(
            '/morphologies/{id}/applyup'.format(id=morphology_5_id),
            params, self.json_headers, self.extra_environ_admin)
        resp = response.json_body
        assert resp[ms1] == [ms1]
        assert resp[ms2] == [ms2]
        ...
        response = self.app.put(
            '/morphologies/{id}/generate_and_compile'.format(id=morphology_6_id),
            headers=self.json_headers,
            extra_environ=self.extra_environ_contrib)
        resp = response.json_body
        compile_attempt = resp['compile_attempt']
        ...
        params = json.dumps({'morpheme_sequences': [ms1, ms2]})
        response = self.app.put(
            '/morphologies/{id}/applyup'.format(id=morphology_6_id),
            params, self.json_headers, self.extra_environ_admin)
        resp = response.json_body
    ...
    def test_i_large_morphologies(self):
        ...
        response = self.app.put(
            '/morphologies/{id}/generate'.format(id=large_morphology_id),
            headers=self.json_headers,
            extra_environ=self.extra_environ_contrib)
        resp = response.json_body
        ...
        if (precompiled_lexc_morphology_path and pregenerated_lexc_morphology_path and 
            ...
            response = self.app.put(
                '/morphologies/{id}/generate_and_compile'.format(id=large_morphology_id),
                headers=self.json_headers,
                extra_environ=self.extra_environ_contrib)
            resp = response.json_body
            compile_attempt = resp['compile_attempt']
        ...
        # Get the compiled foma script.
        response = self.app.get(
            '/morphologies/{id}/servecompiled'.format(
        ...
        response = self.app.put(
            '/morphologies/{id}/applydown'.format(id=large_morphology_id),
            params, self.json_headers, self.extra_environ_admin)
        resp = response.json_body
        morphology_dir_path = os.path.join(self.morphologies_path,
        ...
        response = self.app.put(
            '/morphologies/{id}/applyup'.format(id=large_morphology_id),
            params, self.json_headers, self.extra_environ_admin)
        resp = response.json_body
        morphology_dir_path = os.path.join(self.morphologies_path,
                                        'morphology_%d' % large_morphology_id)
        ...
        # Get the compiled foma script.
        response = self.app.get(
            '/morphologies/{id}/servecompiled'.format(id=large_morphology_id),
            headers=self.json_headers,
            extra_environ=self.extra_environ_admin)
        foma_file = open(morphology_binary_path, 'rb')
        foma_file_content = foma_file.read()

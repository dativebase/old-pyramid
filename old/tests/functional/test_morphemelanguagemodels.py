...
url = MorphemeLanguageModel._url(old_name=TestView.old_name)
...
class TestMorphemelanguagemodelsView(TestView):
    ...
    def test_a_create(self):
        ...
        response = self.app.put(
            '/{old_name}/morphemelanguagemodels/{id}/compute_perplexity'.format(old_name=self.old_name, id=morpheme_language_model_id),
        ...
        response = self.app.get(
            '/{old_name}/morphemelanguagemodels/{id}/serve_arpa'.format(old_name=self.old_name, id=morpheme_language_model_id),
        ...
        response = self.app.put(
            '/{old_name}/morphemelanguagemodels/{id}/get_probabilities'.format(old_name=self.old_name, id=morpheme_language_model_id),

...
# This should help with getting URLs from URL names and params:
# ``request.route_url('foo', a='1', b='2', c='3')``
...
# TODO: how to get the test.ini settings/config file and set up the database
# using it?
...
class TestView(TestCase):
    ...
    def __init__(self, *args, **kwargs):
        print('in constructor of TestView')
    ...
    def tearDown(self, **kwargs):
        ...
        self.request.dbsession.add_all([administrator, contributor, viewer])
